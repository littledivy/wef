...
impl BrowserWindow {
    ...
    fn bind(&self, #[string] name: &str, #[scoped] callback: v8::Global<v8::Function>) {
...
deno_core::extension!(
    ddcore,
    ops = [op_get_system_info, op_get_live_stats, op_get_processes, op_get_args],
...
wef::main!(|| {
    ...
    rt.block_on(async {
        ...
        ISOLATE_PTR.set(SendPtr(runtime.v8_isolate() as *mut _)).ok();
